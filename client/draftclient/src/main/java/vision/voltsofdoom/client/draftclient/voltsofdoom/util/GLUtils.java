...
import static vision.voltsofdoom.client.draftclient.voltsofdoom.util.IOUtil.*;
...
public class GLUtils {
  ...
  /**
   * Write the vertices (position and normal) of an axis-aligned unit box into the provided
   * {@link FloatBuffer}.
   *
   * @param fv the {@link FloatBuffer} receiving the vertex position and normal
   */
  ...
  /**
   * Write the vertices (position and normal) of an axis-aligned box with the given corner
   * coordinates into the provided {@link FloatBuffer}.
   *
