...
public enum ResourceLocationValidityState {
	VALID(true, "ResourceLocation valid!"), TOO_LONG(false, "ResourceLocation spec is too long! (One half of the given spec exceeds 32 characters)"), TOO_SHORT(false, "ResourceLocation spec is too short! (One half of the given spec is less than 4 characters)"),
