...
public class Loggers {
	...
	// Sub System Parts
	public static final Logger ZAPBYTE_LOADING_REGISTRY = Logger.getLogger("zapbyte.loading.registry");
	public static final Logger ZAPBYTE_LOADING_BANDWAGON = Logger.getLogger("zapbyte.loading.bandwagon");
	public static final Logger ZAPBYTE_LOADING_RESOURCE = Logger.getLogger("zapbyte.loading.resource");

	public static final Logger ZAPBYTE_MISCELLANEOUS_MATH = Logger.getLogger("zapbyte.miscellaneous.math");

	// Really fine details
	public static final Logger ZAPBYTE_MISCELLANEOUS_MATH_PICKY = Logger.getLogger("zapbyte.miscellaneous.math.picky");
