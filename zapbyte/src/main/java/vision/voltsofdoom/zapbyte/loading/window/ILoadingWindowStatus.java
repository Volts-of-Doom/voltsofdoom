 ...
 * {@link BandWagon#playEvent(vision.voltsofdoom.zapbyte.bandwagon.Event)}, playing a
 * {@link LoadingWindow.UpdateStatusEvent}.
 * 
...
public interface ILoadingWindowStatus {
  ...
  public static final ILoadingWindowStatus LOCATING_BAND_WAGON_SUBSCRIBERS =
      new ILoadingWindowStatus() {
