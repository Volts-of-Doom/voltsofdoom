...
public class CollectedRegistries {
  ...
  private static final LinkedHashMap<IResourceLocation, IRegistry<? extends IRegistryEntry<?>>> typeRegistries =
      new LinkedHashMap<IResourceLocation, IRegistry<? extends IRegistryEntry<?>>>();
