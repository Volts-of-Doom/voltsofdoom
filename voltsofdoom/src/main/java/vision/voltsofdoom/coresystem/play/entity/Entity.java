...
public class Entity extends RegistryEntry<Entity> {
  ...
  public static class Properties {
    ...
    /**
     * @param image The ImageIcon to set the image attribute of this Tile.Properties object to
  ...
  public static enum Archetype {
    ENTITYBLOB(new Entity.Properties()
        .setImage(new ImageIcon("src/main/resources/image/tile/cobble.png")).setAnimated(false));
