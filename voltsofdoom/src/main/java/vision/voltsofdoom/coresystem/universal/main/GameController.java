...
/**
 * Is the first object to be created when the game starts. Manages loading via the
 * {@link LoadingManager#load()} method, and provides the game's central "catch" block.
 * 
