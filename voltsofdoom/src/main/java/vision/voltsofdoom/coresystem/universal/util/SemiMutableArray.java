...
public class SemiMutableArray<T> implements Iterable<T> {
	...
	public static void main(String[] args) {
		...
		Loggers.ZAPBYTE_MISCELLANEOUS_MATH_PICKY.info("Starting");
		...
		Loggers.ZAPBYTE_MISCELLANEOUS_MATH_PICKY.info(builder.toString());
	}
	...
	public SemiMutableArray() {
		try {
			...
			Loggers.ZAPBYTE_MISCELLANEOUS_MATH.severe("Illegal cast from Object[] to T[] in contents: " + contents);
		}
	}
