package genelectrovise.voltsofdoom_coresystem.universal.util;
...
public class ImageUtil {
	...
	public static class Tailor {
		...
		/**
		 * Combines two images based on the axis put in, with horizontal stitching two
		 * to the right of one; vertical stitching two underneath one.
		 * 
