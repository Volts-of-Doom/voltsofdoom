package genelectrovise.voltsofdoom_coresystem.loading.resource.image;
...
import genelectrovise.voltsofdoom_coresystem.play.adventure.levelcontainer.LevelMap;
...
public class LevelTextureStitcher {
	...
	public BufferedImage stitchAll() {
		try {
			...
			File file = new File(Reference.ROAMING + "img/level/out/" + levelmap.getMeta().getName() + "_stitchedLevel.png");
			file.mkdirs();
